...
<%@page import="youtube.YoutubeItem"%>
...
<html>
    ...
    <body>
        ...
        <div class="container">            
            ...
            <div class="row">
                <form role="form" class="form-horizontal" method="post" action="MovieServlet?method=google">
            ...
            <%
                List<YoutubeItem> item = (List<YoutubeItem>) request.getAttribute("video");
            %>
            ...
            <div class="panel panel-default">
                ...
                <p class="text-justify">
                    <c:forEach var="item" items="${video}">
                        <iframe src="<c:out value=" http://www.youtube.com/embed/${item.getVideoNum()}"/>" height=500 width=500 />
                        </iframe>
                    </c:forEach>
                </p>
